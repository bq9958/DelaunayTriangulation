...
triangulation: $(BUILD_DIR)/mesh.o $(BUILD_DIR)/triangulation.o $(BUILD_DIR)/main_triangulation.o $(BUILD_DIR)/eigen.o $(BUILD_DIR)/lplib3.o $(BUILD_DIR)/libmesh6.o  
	$(CC) $(COPTS) -o $(BUILD_DIR)/triangulation $(BUILD_DIR)/mesh.o $(BUILD_DIR)/triangulation.o $(BUILD_DIR)/main_triangulation.o $(BUILD_DIR)/eigen.o $(BUILD_DIR)/libmesh6.o $(BUILD_DIR)/lplib3.o -lpthread -lm
